// Fase M7 — GET /api/public/summary?token=... Port 1:1 de public_summary() en main.py.
//
// Autenticación por `web_token` en query param (NO JWT) -- así es el
// endpoint público real en Python, pensado para compartir un link de solo
// lectura sin necesidad de loguearse.
